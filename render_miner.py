...
def get_jobs(date_arg):
    # Query string
    #date_str = datetime.date.strftime(date_arg, "%Y-%m-%d")
    query_str = "spooltime > '{0}'".format(date_arg)
...
def write_to_csv(date_str, jobs):
    cvs_file = '/home/abhishek/dev/python/tractor_data_{0}.csv'.format(date_str)
