...
CELERY_ROUTES = {
    ...
    # Line 2
    'task_queue.tasks.UploadTestTask_Line2': {'queue': 'sync_line2'},
    'task_queue.tasks.SpoolTestTask_Line2': {'queue': 'spool_line2'},
    'task_queue.tasks.DownloadTestTask_Line2': {'queue': 'download_line2'},
}
