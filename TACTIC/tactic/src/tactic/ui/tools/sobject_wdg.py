...
class SObjectDetailWdg(BaseRefreshWdg):
    ...
    def get_config_xml(my):
        ...
        try:
            search_key = search_key.split('=')[0] + my.kwargs.get("assembled_code")
        except:
            pass
        ...
        if tabs:
            ...
            if my.search_type == "bs/shot":
                tabs = ["assets_in_shot", "tasks","attachments","snapshots","checkin","edit","pipeline"]
            elif my.search_type == "bs/scene":
                tabs = ["assets_in_scene", "shots", "tasks","attachments","snapshots","checkin","edit","pipeline"]
            elif my.search_type == 'bs/sequence':
                tabs = ["scenes", "tasks","attachments","snapshots","checkin","edit","pipeline"]
            elif my.search_type == 'bs/episode':
                tabs = ["sequences", "tasks","attachments","snapshots","checkin","edit","pipeline"]
            elif my.search_type == "bs/assembled":
                tabs = ["assets_in_assembled", "attachments","snapshots","checkin","edit","pipeline"]
            elif my.search_type == "bs/asset":
                tabs = ["assets_in_asset", "tasks","attachments","snapshots","checkin","edit","pipeline"]
            else:
                tabs = ["tasks","attachments","snapshots","checkin","edit","pipeline"]

        for tab in tabs:
            if tab == "assets_in_shot":
                config_xml.append('''
                <element name="assets">
                <display class='tactic.ui.panel.ViewPanelWdg'>
                    <search_type>bs/asset_in_shot</search_type>
                    <view>ast_tsk_short_list</view>
            ...
            elif tab == "assets_in_scene":
                config_xml.append('''
                <element name="assets">
                <display class='tactic.ui.panel.ViewPanelWdg'>
                    <search_type>bs/asset_in_scene</search_type>
                    <view>assets_in_scene_list</view>
                    <parent_key>%(search_key)s</parent_key>
                    <width>100%%</width>
                    <show_shelf>true</show_shelf>
                </display>
                ...
                <display class='tactic.ui.panel.ViewPanelWdg'>
                    <search_type>bs/sequence</search_type>
                ...
                <element name="Scenes">
                <display class='tactic.ui.panel.ViewPanelWdg'>
                    <search_type>bs/scene</search_type>
                    <view>table</view>
                    <parent_key>%(search_key)s</parent_key>
                    <width>100%%</width>
                    <show_shelf>true</show_shelf>
                ...
                <element name="Shots">
                <display class='tactic.ui.panel.ViewPanelWdg'>
                    <search_type>bs/shot</search_type>
                    <view>scn_shots_view</view>
                    <parent_key>%(search_key)s</parent_key>
                    <width>100%%</width>
                    <show_shelf>true</show_shelf>
                </display>
            ...
            elif tab == "assets_in_assembled":
                config_xml.append('''
                <element name="assets">
                <display class='tactic.ui.panel.ViewPanelWdg'>
                    <search_type>bs/asset_in_assembled</search_type>
                    <view>assets_in_assembled_list</view>
                    <parent_key>%(search_key)s</parent_key>
                    <width>100%%</width>
                    <show_shelf>true</show_shelf>
                </display>
