...
class SthpwUpgrade(BaseUpgrade):
    ...
    # 4.0.0.b03
    #
    def upgrade_v4_0_0_b03_002(my):

        if my.is_confirmed not in [True, 'true']:
            print '''
...
IMPORTANT NOTICE:
    ...
    # 4.0.0.a03
    #
    def critical_v4_0_0_a03_006(my):
        my.run_sql('''
    ...
    def upgrade_v4_0_0_a03_004(my):
        my.run_sql('''
        CREATE UNIQUE INDEX sync_log_transaction_idx ON sync_log (transaction_code)
        ''')

    def upgrade_v4_0_0_a03_003(my):
        my.run_sql('''ALTER TABLE wdg_settings ADD COLUMN code varchar(256);''')



    def upgrade_v4_0_0_a03_002(my):
        my.run_sql('''INSERT INTO search_object (code, search_type, namespace, description, "database", table_name, class_name, title, "schema") VALUES ('sthpw/sync_log', 'sthpw/sync_log', 'sthpw', 'List of all processed incoming sync jobs', 'sthpw', 'sync_log', 'pyasm.search.SObject', 'Sync Log', 'public');
        ''')

    def upgrade_v4_0_0_a03_001(my):
        my.run_sql('''
    ...
    def critical_v4_0_0_a02_008(my):
        my.run_sql('''
        CREATE UNIQUE INDEX change_timestamp_idx ON change_timestamp (search_type, search_code)
        ''')


    def upgrade_v4_0_0_a02_007(my):
        my.run_sql('''
        ALTER TABLE prod_setting add CONSTRAINT prod_setting_code_unique UNIQUE (code);
        ''')

    def upgrade_v4_0_0_a02_006(my):
        my.run_sql('''ALTER TABLE prod_setting ADD COLUMN code varchar(256);''')

    def upgrade_v4_0_0_a02_005(my):
        my.run_sql('''ALTER TABLE sync_server ADD COLUMN base_dir text;''')

    def upgrade_v4_0_0_a02_004(my):
        my.run_sql('''ALTER TABLE sync_server ADD COLUMN sync_mode varchar(256);''')

 

    def upgrade_v4_0_0_a02_003(my):
        my.run_sql('''ALTER TABLE sync_server ADD COLUMN description text;''')

 
    def upgrade_v4_0_0_a02_002(my):
        my.run_sql('''ALTER TABLE sync_server ADD COLUMN access_rules text;''')



    def upgrade_v4_0_0_a02_001(my):
        my.run_sql('''ALTER TABLE sobject_list ADD COLUMN search_code VARCHAR(256);''')
    ...
    """
    def upgrade_v4_0_0_a01_041(my):
        my.run_sql('''ALTER TABLE task alter column "bid_start_date" type timestamp with time zone;
    ...
    def upgrade_v4_0_0_a01_039(my):
        my.run_sql('''ALTER TABLE login_group ADD COLUMN code VARCHAR(256);''')

    def upgrade_v4_0_0_a01_038(my):
        my.run_sql('''CREATE INDEX "work_hour_task_idx" on work_hour (task_code);''')

    def upgrade_v4_0_0_a01_037(my):
        my.run_sql('''CREATE INDEX "work_hour_search_type_search_code_idx" on work_hour (search_type, search_code);''')

    def upgrade_v4_0_0_a01_036(my):
        my.run_sql('''CREATE INDEX "sync_job_state_idx" on sync_job (state);''')

    def upgrade_v4_0_0_a01_035(my):
        my.run_sql('''CREATE INDEX "task_search_type_search_code_idx" on task (search_type, search_code);''')

    def upgrade_v4_0_0_a01_034(my):
        my.run_sql('''CREATE INDEX "note_search_type_search_code_idx" on note (search_type, search_code);''')


    def upgrade_v4_0_0_a01_033(my):
        my.run_sql('''CREATE INDEX "snapshot_search_type_search_code_idx" on snapshot (search_type, search_code);''')





    def upgrade_v4_0_0_a01_032(my):
        my.run_sql('''ALTER TABLE sync_job ADD COLUMN server_code varchar(256);''')
    ...
    def upgrade_v4_0_0_a01_029(my):
        my.run_sql('''ALTER TABLE snapshot ADD COLUMN server varchar(256);''')



    def upgrade_v4_0_0_a01_028(my):
        my.run_sql('''ALTER TABLE custom_property ADD COLUMN code varchar(256);''')


    def upgrade_v4_0_0_a01_027(my):
        my.run_sql('''ALTER TABLE work_hour ADD COLUMN search_code varchar(256);''')
    ...
    def upgrade_v4_0_0_a01_025(my):
        my.run_sql('''ALTER TABLE ticket ADD COLUMN code varchar(256);''')



    def upgrade_v4_0_0_a01_024(my):
        my.run_sql('''ALTER TABLE transaction_log ADD COLUMN description text;''')



    def upgrade_v4_0_0_a01_023(my):
        my.run_sql('''ALTER TABLE transaction_log ADD COLUMN description text;''')



    def upgrade_v4_0_0_a01_022(my):
        my.run_sql('''ALTER TABLE transaction_log ADD COLUMN server_code varchar(256);''')



    def upgrade_v4_0_0_a01_021(my):
        my.run_sql('''ALTER TABLE sync_server ADD COLUMN ticket varchar(256);''')



    def upgrade_v4_0_0_a01_020(my):
        my.run_sql('''ALTER TABLE clipboard ADD COLUMN code varchar(256);''')


    def upgrade_v4_0_0_a01_019(my):
        my.run_sql('''ALTER TABLE transaction_log ADD COLUMN state varchar(256);''')





    def upgrade_v4_0_0_a01_018(my):
        my.run_sql('''ALTER TABLE transaction_log ADD COLUMN ticket varchar(256);''')





    def upgrade_v4_0_0_a01_017(my):
        my.run_sql('''INSERT INTO "search_object" ("code","search_type", "namespace", "description", "database", "table_name", "class_name", "title", "schema") VALUES ('sthpw/sync_server', 'sthpw/sync_server', 'sthpw', 'Sync Server', 'sthpw', 'sync_server', 'pyasm.search.SObject', 'Sync Server', 'public');
        ''')

    def upgrade_v4_0_0_a01_016(my):
        my.run_sql('''
    ...
    def upgrade_v4_0_0_a01_015(my):
        my.run_sql('''INSERT INTO "search_object" ("code", "search_type", "namespace", "description", "database", "table_name", "class_name", "title", "schema") VALUES ('sthpw/sync_job','sthpw/sync_job', 'sthpw', 'Sync Job', 'sthpw', 'sync_job', 'pyasm.search.SObject', 'Sync Job', 'public');
        ''')

    def upgrade_v4_0_0_a01_014(my):
        my.run_sql('''
    ...
    def upgrade_v4_0_0_a01_013(my):
        my.run_sql('''CREATE UNIQUE INDEX transaction_log_code_idx on transaction_log(code);''')


    def upgrade_v4_0_0_a01_012(my):
        my.run_sql('''ALTER TABLE transaction_log ADD COLUMN code VARCHAR(256);''')




    def upgrade_v4_0_0_a01_011(my):
        my.run_sql('''ALTER TABLE note ADD COLUMN search_code VARCHAR(256);''')





    def upgrade_v4_0_0_a01_010(my):
        my.run_sql('''ALTER TABLE retire_log ADD COLUMN code VARCHAR(256);''')



    def upgrade_v4_0_0_a01_009(my):
        my.run_sql('''ALTER TABLE note ADD COLUMN code VARCHAR(256);''')



    def upgrade_v4_0_0_a01_008(my):
        my.run_sql('''ALTER TABLE status_log ADD COLUMN code VARCHAR(256);''')




    def upgrade_v4_0_0_a01_007(my):
        my.run_sql('''ALTER TABLE status_log ADD COLUMN search_code VARCHAR(256);''')



    def upgrade_v4_0_0_a01_006(my):
        my.run_sql('''ALTER TABLE sobject_log ADD COLUMN search_code VARCHAR(256);''')



    def upgrade_v4_0_0_a01_005(my):
        my.run_sql('''ALTER TABLE task ADD COLUMN search_code VARCHAR(256);''')


    def upgrade_v4_0_0_a01_004(my):
        my.run_sql('''ALTER TABLE snapshot ADD COLUMN search_code VARCHAR(256);''')


    def upgrade_v4_0_0_a01_003(my):
        my.run_sql('''ALTER TABLE file ADD COLUMN search_code VARCHAR(256);''')




    def upgrade_v4_0_0_a01_002(my):
        my.run_sql('''ALTER TABLE queue ADD COLUMN interval INTEGER;''')

    def upgrade_v4_0_0_a01_001(my):
        my.run_sql('''ALTER TABLE queue ADD COLUMN code VARCHAR(256);''')
    ...
    # 3.8.0.v05
    #
    def upgrade_v3_8_0_v05_021(my):
        my.run_sql('''  
            UPDATE "work_hour" set category='regular' where category is NULL;
        ''')

    def upgrade_v3_8_0_v05_020(my):
        my.run_sql('''  
            CREATE INDEX "note_search_type_search_id_idx" on note (search_type, search_id);
        ''')

    def upgrade_v3_8_0_v05_019(my):
        my.run_sql('''  
            CREATE INDEX "snapshot_search_type_search_id_idx" on snapshot (search_type, search_id);
        ''')

    def upgrade_v3_8_0_v05_018(my):
        my.run_sql('''  
            CREATE INDEX "sobject_list_search_type_search_id_idx" on sobject_list (search_type, search_id);
        ''')

    def upgrade_v3_8_0_v05_017(my):
        my.run_sql('''  
            CREATE INDEX "status_log_search_type_search_id_idx" on status_log (search_type, search_id);
        ''')

    def upgrade_v3_8_0_v05_016(my):
        my.run_sql('''  
            CREATE INDEX "task_search_type_search_id_idx" on task (search_type, search_id);
        ''')

    def upgrade_v3_8_0_v05_015(my):
        my.run_sql('''  
            ALTER TABLE sobject_list add constraint "sobject_list_code_idx" UNIQUE (code);
        ''')


    def upgrade_v3_8_0_v05_013(my):
        my.run_sql('''
        CREATE TABLE special_day (
    id serial PRIMARY KEY,
    code character varying(256),
    ...
    def upgrade_v3_8_0_v05_012(my):
        my.run_sql('''
        ALTER TABLE search_object add constraint search_object_search_type_idx UNIQUE(search_type);
        ''')

    def upgrade_v3_8_0_v05_011(my):
        my.run_sql('''
    CREATE TABLE repo (
    id serial PRIMARY KEY,
    code character varying(256) NOT NULL,
...
INSERT INTO "search_object" ("code", "search_type", "namespace", "description", "database", "table_name", "class_name", "title", "schema") VALUES ('prod/session_contents','prod/session_contents', 'prod', 'Introspection Contents of a users session', '{project}', 'session_contents', 'pyasm.prod.biz.SessionContents', 'Session Contents', 'public')
    ...
    def upgrade_v3_8_0_rc03_004(my):
        my.run_sql('''
INSERT INTO "search_object" ("search_type", "namespace", "description", "database", "table_name", "class_name", "title", "schema") VALUES ('prod/session_contents', 'prod', 'Introspection Contents of a users session', '{project}', 'session_contents', 'pyasm.prod.biz.SessionContents', 'Session Contents', 'public')
    ...
    def upgrade_v3_8_0_rc03_001(my):
        my.run_sql('''
        ALTER TABLE work_hour ADD "task_code" varchar(256);
        ''')
    ...
    def upgrade_v3_6_0_rc03_001(my):
        my.run_sql('''ALTER TABLE login_group ADD COlUMN code varchar(256)''')
    ...
    def upgrade_v3_6_0_b01_004(my):
        my.run_sql('''
        INSERT INTO pref_list ("key",description,options,"type",category,title) VALUES ('palette','Color Palette to determine the look and feel','Aqua|Dark|Silver|Bright|Origami|NReal|Bon Noche|Aviator','sequence','display','Color Palette');
        ''')
