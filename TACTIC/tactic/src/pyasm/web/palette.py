...
class Palette(object):
    ...
    # Nothing Real theme
    NREAL = {
    'color':        '#AAAAAA',      # main font color
    'color2':       '#FFAA00',      # secondary font color
    'color3':       '#AAAAAA',      # tertiary font color
    'background':   '#181923',      # main background color
    'background2':  '#101012',      # secondary background color
    'background3':  '#3a1818',      # tertiary background color
    'border':       '#444',         # main border color
    'table_border': '#060719',
    'theme': 'dark',
    'side_bar_title': '#000323',
    'side_bar_title_color': '#FFAA00',
    'tab_background': '#000323',
    'shadow':       'rgba(0,0,0,0.4)',
    }

    # Nothing Real theme 1
    #NREAL = {
    #'color':        '#FFFFFF',      # main font color
    #'color2':       '#FFAA00',      # secondary font color
    #'color3':       '#AAAAAA',      # tertiary font color
    #'background':   '#333443',      # main background color
    #'background2':  '#12122a',      # secondary background color
    #'background3':  '#151623',      # tertiary background color
    #'border':       '#444',         # main border color
    #'table_border': '#2C2D3A',
    #'theme': 'dark'
    #}

    # Nothing Real theme 2
    #NREAL = {
    #'color':        '#AAAAAA',      # main font color
    #'color2':       '#FFAA00',      # secondary font color
    #'color3':       '#9090FF',      # tertiary font color
    #'background':   '#2C2D3A',      # main background color
    #'background2':  '#12122a',      # secondary background color
    #'background3':  '#10102a',      # tertiary background color
    #'border':       '#444',         # main border color
    #'table_border': '#2C2D3A',
    #'theme': 'dark'
    #}
