...
__all__ = ['TestToolWdg', 'TestUserToolWdg']
...
class TestToolWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        div.add("<b>Select any user from the side pane</b>")
    ...
    def get_group_wdg(my):
        ...
        search.add_filters("project_code", ['ziryab'], op='in')
        ...
        #groups = [obj for obj in search.get_sobjects() if 'user' in obj.get_name()]
    ...
    def get_logins_wdg(my, logins):
        ...
        for login in logins:
            ...
            var class_name = 'tactic.ui.tools.test_wdg.TestUserToolWdg';
...
class TestUserToolWdg(BaseRefreshWdg):
    ...
    def get_display(my):
        ...
        config_xml.append('''
        <element name='user_task_assignment'>
          <display class='tactic.ui.panel.AP_ViewPanelWdg'>
            <search_type>sthpw/task</search_type>
            <view>table</view>
        ...
        config_xml.append('''
          <element name='custom_chart_01' title="Task Assignment Status" image="GRAPH_LINE_04" description="Task Assignment Status">
            <display class="tactic.ui.chart.chart_abhishek_wdg.AbhishekBarChartWdg">
              <title>Task Assignment Status</title>
              <labels>Pending|Assignment|In progress|Approved|Review</labels>
              <user>%s</user>
              <!--<x_title>Time</x_title>-->
             <class_name>tactic.ui.chart.chart_abhishek_wdg.AbhishekBarChartWdg</class_name>
             <cell_width>300px</cell_width>
             <cell_height>150px</cell_height>
           </display>
          </element>
        ''' % login)
