...
#
#
__all__ = ["AP_FastTableLayoutWdg", "TableLayoutWdg", "TableGroupManageWdg"]
...
#class AP_FastTableLayoutWdg(TableLayoutWdg):


class AP_FastTableLayoutWdg(BaseTableLayoutWdg):
    ...
    def get_display(my):
        ...
        if my.view_editable and my.edit_permission:
            ...
            for name, edit_wdg in my.edit_wdgs.items():
                # each BaseInputWdg knows about this AP_FastTableLayoutWdg
        ...
        if sticky_header:
            ...
            scroll.add_style("min-height: 750px")
            """
            scroll.add_behavior( {
                'type': 'load',
                'cbjs_action': '''
...
spt.table.add_rows = function(row, search_type, level) {
    ...
    var class_name = 'tactic.ui.panel.table_layout_wdg.AP_FastTableLayoutWdg';
...
class TableLayoutWdg(AP_FastTableLayoutWdg):
    pass
