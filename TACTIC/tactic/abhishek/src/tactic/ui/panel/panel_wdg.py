...
#
#
__all__ = ["SideBarPanelWdg", "SideBarBookmarkMenuWdg", "ViewPanelWdg", "ViewPanelSaveWdg", "AP_ViewPanelWdg"]
...
class AP_ViewPanelWdg(BaseRefreshWdg):
    '''Panel which displays a complete view, including filters, search
    and results'''
    ...
    def get_display(my):
        ...
        if can_search:
            ...
            # Fast(Base) Table Layout will take care of hiding it
            inner.add(search_dialog)
            search_dialog.add_title("_ Advanced Search _")
            search_dialog.add(search_wdg)
        ...
        from ap_table_layout_wdg import AP_FastTableLayoutWdg
        layout_table = AP_FastTableLayoutWdg(**kwargs)
        layout_table.set_search_wdg(search_wdg)
